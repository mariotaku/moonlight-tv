...
// From https://chromium.googlesource.com/chromium/src/+/master/media/formats/common/opus_constants.h
...
enum
{
  ...
  OPUS_MAX_VORBIS_CHANNELS = AUDIO_CONFIGURATION_MAX_CHANNEL_COUNT,
