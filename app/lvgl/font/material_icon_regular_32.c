...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 750, .adv_w = 512, .box_w = 30, .box_h = 24, .ofs_x = 1, .ofs_y = 4},
    {.bitmap_index = 1110, .adv_w = 512, .box_w = 20, .box_h = 20, .ofs_x = 6, .ofs_y = 6},
    {.bitmap_index = 1310, .adv_w = 512, .box_w = 30, .box_h = 24, .ofs_x = 1, .ofs_y = 4},
    {.bitmap_index = 1670, .adv_w = 512, .box_w = 28, .box_h = 28, .ofs_x = 2, .ofs_y = 2},
    {.bitmap_index = 2062, .adv_w = 512, .box_w = 22, .box_h = 29, .ofs_x = 5, .ofs_y = 2},
    {.bitmap_index = 2381, .adv_w = 512, .box_w = 28, .box_h = 28, .ofs_x = 2, .ofs_y = 2}
};
