...
NK_API nk_bool nk_smooth_list_view_begin(struct nk_context *ctx, struct nk_list_view *view,
    const char *title, nk_flags flags, int row_height, int row_count);

NK_API void nk_smooth_list_view_end(struct nk_list_view *view);
 ...
 * ===============================================================*/
NK_API nk_bool
nk_smooth_list_view_begin(struct nk_context *ctx, struct nk_list_view *view,
    const char *title, nk_flags flags, int row_height, int row_count)
{
    int title_len;
    nk_hash title_hash;
...
NK_API void
nk_smooth_list_view_end(struct nk_list_view *view)
{
