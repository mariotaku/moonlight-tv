...
void nk_spritesheet_init_ui_1x(struct nk_image sprites, struct nk_spritesheet_ui *sheet)
{
    ...
    sheet->ic_play = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(32, 60, 18, 18));
    sheet->ic_refresh = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(0, 64, 24, 24));
    sheet->ic_remote_back = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(50, 60, 16, 16));
    sheet->ic_remote_blue = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(66, 64, 16, 16));
    sheet->ic_remote_center = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(50, 76, 16, 16));
    sheet->ic_remote_green = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(82, 64, 16, 16));
    sheet->ic_remote_red = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(24, 78, 16, 16));
    sheet->ic_remote_yellow = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(0, 88, 16, 16));
    sheet->ic_settings = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(0, 104, 24, 24));
    sheet->ic_warning = nk_subimage_handle(sprites.handle, 128, 128, nk_rect(98, 72, 18, 18));
}
...
void nk_spritesheet_init_ui_2x(struct nk_image sprites, struct nk_spritesheet_ui *sheet)
{
    ...
    sheet->ic_play = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(64, 120, 36, 36));
    sheet->ic_refresh = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(0, 128, 48, 48));
    sheet->ic_remote_back = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(100, 120, 32, 32));
    sheet->ic_remote_blue = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(132, 128, 32, 32));
    sheet->ic_remote_center = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(100, 152, 32, 32));
    sheet->ic_remote_green = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(164, 128, 32, 32));
    sheet->ic_remote_red = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(48, 156, 32, 32));
    sheet->ic_remote_yellow = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(0, 176, 32, 32));
    sheet->ic_settings = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(0, 208, 48, 48));
    sheet->ic_warning = nk_subimage_handle(sprites.handle, 256, 256, nk_rect(196, 144, 36, 36));
}
...
void nk_spritesheet_init_ui_3x(struct nk_image sprites, struct nk_spritesheet_ui *sheet)
{
    ...
    sheet->ic_play = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(96, 180, 54, 54));
    sheet->ic_refresh = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(0, 192, 72, 72));
    sheet->ic_remote_back = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(150, 180, 48, 48));
    sheet->ic_remote_blue = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(198, 192, 48, 48));
    sheet->ic_remote_center = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(150, 228, 48, 48));
    sheet->ic_remote_green = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(246, 192, 48, 48));
    sheet->ic_remote_red = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(72, 234, 48, 48));
    sheet->ic_remote_yellow = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(0, 264, 48, 48));
    sheet->ic_settings = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(0, 312, 72, 72));
    sheet->ic_warning = nk_subimage_handle(sprites.handle, 384, 384, nk_rect(294, 216, 54, 54));
}
