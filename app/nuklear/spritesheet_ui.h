...
void nk_spritesheet_init_ui_1x(struct nk_image sprites, struct nk_spritesheet_ui *sheet)
{
    ...
    sheet->ic_gamepad_a = nk_subimage_handle(sprites.handle, 128, 64, nk_rect(0, 48, 16, 16));
    sheet->ic_gamepad_view = nk_subimage_handle(sprites.handle, 128, 64, nk_rect(16, 48, 16, 16));
    sheet->ic_gamepad_x = nk_subimage_handle(sprites.handle, 128, 64, nk_rect(32, 48, 16, 16));
    ...
    sheet->ic_remote_blue = nk_subimage_handle(sprites.handle, 128, 64, nk_rect(66, 18, 16, 16));
    sheet->ic_remote_center = nk_subimage_handle(sprites.handle, 128, 64, nk_rect(108, 0, 16, 16));
    sheet->ic_remote_green = nk_subimage_handle(sprites.handle, 128, 64, nk_rect(108, 16, 16, 16));
    sheet->ic_remote_red = nk_subimage_handle(sprites.handle, 128, 64, nk_rect(82, 24, 16, 16));
    sheet->ic_remote_yellow = nk_subimage_handle(sprites.handle, 128, 64, nk_rect(72, 40, 16, 16));
    sheet->ic_settings = nk_subimage_handle(sprites.handle, 128, 64, nk_rect(88, 40, 24, 24));
}
...
void nk_spritesheet_init_ui_2x(struct nk_image sprites, struct nk_spritesheet_ui *sheet)
{
    ...
    sheet->ic_gamepad_a = nk_subimage_handle(sprites.handle, 256, 128, nk_rect(0, 96, 32, 32));
    sheet->ic_gamepad_view = nk_subimage_handle(sprites.handle, 256, 128, nk_rect(32, 96, 32, 32));
    sheet->ic_gamepad_x = nk_subimage_handle(sprites.handle, 256, 128, nk_rect(64, 96, 32, 32));
    ...
    sheet->ic_remote_blue = nk_subimage_handle(sprites.handle, 256, 128, nk_rect(132, 36, 32, 32));
    sheet->ic_remote_center = nk_subimage_handle(sprites.handle, 256, 128, nk_rect(216, 0, 32, 32));
    sheet->ic_remote_green = nk_subimage_handle(sprites.handle, 256, 128, nk_rect(216, 32, 32, 32));
    sheet->ic_remote_red = nk_subimage_handle(sprites.handle, 256, 128, nk_rect(164, 48, 32, 32));
    sheet->ic_remote_yellow = nk_subimage_handle(sprites.handle, 256, 128, nk_rect(144, 80, 32, 32));
    sheet->ic_settings = nk_subimage_handle(sprites.handle, 256, 128, nk_rect(176, 80, 48, 48));
}
...
void nk_spritesheet_init_ui_3x(struct nk_image sprites, struct nk_spritesheet_ui *sheet)
{
    ...
    sheet->ic_gamepad_a = nk_subimage_handle(sprites.handle, 384, 192, nk_rect(0, 144, 48, 48));
    sheet->ic_gamepad_view = nk_subimage_handle(sprites.handle, 384, 192, nk_rect(48, 144, 48, 48));
    sheet->ic_gamepad_x = nk_subimage_handle(sprites.handle, 384, 192, nk_rect(96, 144, 48, 48));
    ...
    sheet->ic_remote_blue = nk_subimage_handle(sprites.handle, 384, 192, nk_rect(198, 54, 48, 48));
    sheet->ic_remote_center = nk_subimage_handle(sprites.handle, 384, 192, nk_rect(324, 0, 48, 48));
    sheet->ic_remote_green = nk_subimage_handle(sprites.handle, 384, 192, nk_rect(324, 48, 48, 48));
    sheet->ic_remote_red = nk_subimage_handle(sprites.handle, 384, 192, nk_rect(246, 72, 48, 48));
    sheet->ic_remote_yellow = nk_subimage_handle(sprites.handle, 384, 192, nk_rect(216, 120, 48, 48));
    sheet->ic_settings = nk_subimage_handle(sprites.handle, 384, 192, nk_rect(264, 120, 72, 72));
}
