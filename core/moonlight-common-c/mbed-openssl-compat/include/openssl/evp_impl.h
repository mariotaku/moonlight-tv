...
int mbed_EVP_DecryptInit_ex(struct EVP_CIPHER_CTX_T *ctx,
                            const mbedtls_cipher_type_t cipher, void *impl,
                            const unsigned char *key,
                            const unsigned char *iv);

int mbed_EVP_DecryptUpdate(struct EVP_CIPHER_CTX_T *ctx, unsigned char *out,
                           int *outl, const unsigned char *in, int inl);

int mbed_EVP_DecryptFinal_ex(struct EVP_CIPHER_CTX_T *ctx, unsigned char *out,
                             int *outl);
